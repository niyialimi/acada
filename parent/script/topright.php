...
$_SESSION['toprightparent'].='<div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="header">You have '.$_SESSION['total'].' messages</li>
                  <li>
                  ...
                  <li class="footer"><a href="myinbox.php">See All Messages</a></li>
                </ul>
              </li>';
...
$result=mysqli_query($con,$noticequery);
 ...
 $_SESSION['toprightparent'].='<!-- Notifications: style can be found in dropdown.less -->
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs">'.$_SESSION['parentusername'].'</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../dist/img/avatar5.png" class="img-circle" alt="User Image"> 
                    <p>'.$_SESSION['parentusername'].'</p>                  
                  </li>
                  
                  <!-- Menu Footer-->
                  <li class="user-footer"> 
                  <div class="pull-left">
                      <a href="mykids.php" class="btn btn-success btn-flat">My Kids    <i class="fa fa-graduation-cap"></i></a>
                    </div>                   
