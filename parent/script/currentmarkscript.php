...
$selectquery = "select student_tab.*,setting_tab.current_term,setting_tab.current_session from student_tab inner join setting_tab on student_tab.clientapp_id=setting_tab.clientapp_id where student_id='".$_POST["stdid"]."' and setting_tab.clientapp_id='".$_SESSION['clientappid']."'";
