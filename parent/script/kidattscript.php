...
if($monthName && $attendsession && $stdid && $attendterm)
{
$month=$month;
$year=date('Y');
...
FROM student_tab inner join stdattend_tab on student_tab.student_id=stdattend_tab.student_id where stdattend_tab.month='$monthName' and stdattend_tab.csession='$attendsession' and stdattend_tab.cterm='$attendterm'  and stdattend_tab.student_id='$stdid' and stdattend_tab.clientapp_id='".$_SESSION['clientappid']."'  GROUP BY stdattend_tab.student_id" ;
...
if(mysqli_num_rows($result))
 ...
 {
	 echo '<table><tr align="center"><td>No Record For The Month Or Term Selected Yet</td></tr></table>';
 }
}
