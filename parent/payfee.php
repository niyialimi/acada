              ...
              <div class="box">
                ...
                <div class="box-body">
                  <div class="row">
							 ...
							 $id=$_GET['id'];							
							 $xquery="select student_tab.lname,student_tab.fname,student_tab.oname,student_tab.pemail,student_tab.parent_phone,setpayment.pay_class,setpayment.pay_amount,setpayment.pay_name from student_tab right join setpayment on student_tab.current_class=setpayment.pay_class where student_tab.student_id='$id' and setpayment.clientapp_id='".$_SESSION['clientappid']."'";
                                 ...
                                 <form action="" name="paye" id="paymentform" class="payform" method="post" enctype="multipart/form-data" role="form" data-toggle="validator">
                                   <div class="form-group">
                                    <label for="" class="control-label">Student Name</label>
                                      ...
                                      <input type="text" class="form-control" name="stdname" id="stdname" value="<?php echo $rows['lname']." ".$rows['fname']; ?>" placeholder="Student Name" readonly>
                                      
                                   
                                  </div>
                                  <div class="form-group">
                                    <label for="" class="control-label">Pay Type</label>
                                    
                                      <select class="form-control" name="paytype" id="paytype" required>
                                      	<option value="">Select Type Of Payment</option>
                                      <option value="<?php echo $rows['pay_name']; ?>"><?php echo $rows['pay_name']; ?></option>
                                      </select>
                                  ...
                                  <div class="form-group">
                                    <label for="" class="control-label">Amount</label>
                                      ...
                                      <input type="text" class="form-control" name="amountpaid" id="amountpaid" value="<?php echo $rows['pay_amount']; ?>" placeholder="Amount To Pay" readonly>
                                    
                                  </div>      
                                  <div class="form-group">
                                    <label for="" class="control-label">Email</label>
                                    
                                      <input type="email" class="form-control" name="pemail" id="pemail" value="<?php echo $rows['pemail']; ?>" placeholder="Parent Email" readonly>
                                   
                                  </div> 
                                  
                                  <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-10">
                                      <button type="button" name="checkout" id="checkout" class="btn btn-info">Check Out</button>
                                    </div>
                                  </div>                 
                                 </form>
                                 <?php 
