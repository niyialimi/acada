              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="mymessage.php"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">
                    	<?php
                    ...
                    <li class="active"><a href="msgsent.php"><i class="fa fa-envelope-o"></i> Sent</a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">                  
                    ...
                    <?php
							 ...
							 $xquery="select * from message_tab where msg_senderid='".$_SESSION['adminid']."' order by msg_id desc";
							 $output=mysqli_query($con,$xquery);
							 if(mysqli_num_rows($output))
							   {$fullclass='';
								   while($rows=mysqli_fetch_array($output))
