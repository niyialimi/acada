              ...
              <div class="box box-warning">
                ...
                <?php 
				  	$neid=$_GET['neid'];
							 ...
							 $xquery="select * from newsevent_tab where ne_id='$neid' and clientapp_id='".$_SESSION['clientappid']."'";
                  ...
                  <div class="mailbox-read-info">
                    <h5><?php echo $type; ?>&nbsp;&nbsp;<strong><?php echo $rows['ne_title']; ?></strong></h5>
                    <h4>Posted By: System Admin <span class="mailbox-read-time pull-right"><?php echo $rows['publish_date']."  ".$rows['publish_time']; ?></span></h4>
                  ...
                  <div class="mailbox-read-message">
                    <p><?php echo $rows['ne_body']; ?></p>
                  
                  
                </div><!-- /.box-footer -->
                 <?php 
						 $update="update newsevent_tab set ne_readstatus=1 where ne_id='".$_SESSION['neid']."' and clientapp_id='".$_SESSION['clientappid']."' ";
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <!--button class="btn btn-default"><i class="fa fa-reply"></i> Reply</butto--n>
