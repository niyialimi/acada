...
<html>
  <head>
    ...
    <title>::Communicate | Latest News</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Publish News</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <form action="" class="newsevent" id="newseventform"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">
                
                <div class="form-group">
                    <input name="netitle" id="netitle" class="form-control" placeholder="News Title Not More Than 200 characters" value="" required>
                  </div>
                  <input type="hidden" name="netype" id="netype" value="news">
                  <div class="form-group">
                   <textarea class="form-control" name="nebody" id="nebody" rows="5" maxlength="1000" placeholder="Maximum Character is 1000char" required></textarea>
                    <span class="counter"></span>
                  </div>
                  <div id="message"></div>
                <div class="box-footer">
                  <div class="pull-right">
                    <button type="submit" name="nebut" id="nebut" class="btn btn-primary" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Publishing News">Publish News <i class="fa fa-newspaper-o"></i></button>
                  </div>
          ...
          <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Last 5 Published News</h3>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">                  
                    ...
                    <?php
							 ...
							 $xquery="select * from newsevent_tab where ne_type='news' and publish_status=1 and clientapp_id='".$_SESSION['clientappid']."' order by ne_id desc limit 5";
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="#"><?php if($rows['publish_status']==1){echo 'Published';}else{echo 'Not Published';}; ?></a></td>
                          <td class="mailbox-subject"><b><?php echo $rows['ne_title']; ?></b> </td>
                          <td class="mailbox-attachment"><i class="fa fa-calender"></i><?php echo $rows['publish_date']; ?></td>
                          <td class="mailbox-date"><i class="fa fa-time"></i><?php echo $rows['publish_time']; ?></td>
                        </tr>
                        <?php 
							   }
							}else{
						?>
                        <tr>
                        <td colspan="5"><i class="fa fa-time"></i><?php echo "No News Data Yet"; ?></td>
                        </tr>
                        <?php }?>
                      </tbody>
                    </table><!-- /.table -->
