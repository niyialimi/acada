		...
		<div class="box" id="regbox">
            <div class="box">
                <div class="box-header">
                  <h4 class="box-title well-lg"><i class="fa fa-calender"></i>  Staff Monthly Attendance Report</strong></h4>
                  ...
                  <div class="col-md-3">
                  	...
                  	<select class="form-control" name="staffattendmonth" id="staffattendmonth">
                  ...
                  <div class="col-md-3">
                  	<select class="form-control" name="staffattendsession" id="staffattendsession" required>
                  ...
                  <div class="col-md-3">
                  <select class="form-control" name="staffattendterm" id="staffattendterm" required>
                  ...
                  <div class="col-md-3">
                  <select class="form-control" name="staffattendtype" id="staffattendtype">
