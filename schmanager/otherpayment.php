...
<html>
        ...
        <div class="box" id="regbox">
            <div class="box">
                <div class="box-header">
                 <div class="alert alert-info" role="alert" align="center"><strong>Please Select The Class You Wish to Manage Fund For. Note Classes That Payment Has Not Been Set For Will Return An Empty Table</strong></div>
                  ...
                  <div class="row">
                  <form action="" name="payform" class="" id=""  enctype="multipart/form-data" method="post" role="form">
                 ...
                 <div class="col-md-3">
                    ...
                    <?php
				$selectquery = "select * from setpayment where pay_name!='School Fees' and clientapp_id='".$_SESSION['clientappid']."'";
			$searchData=mysqli_query($con,$selectquery);
			 if(mysqli_num_rows($searchData))
			{
				while($rows=mysqli_fetch_assoc($searchData))
			   {	
							
                  		 echo '<option value='.$rows['pay_name'].'>'.$rows['pay_name'].'</option>';
                ...
                <form action="" name="paytable" class="atform" id="stdattform"  enctype="multipart/form-data" method="post" role="form">
 ...
 $(document).ready(function(e){
	$("#paytype").change(function(){
			...
			var schclass=payform.schclass.value;
		$.ajax({
	  	type: 'POST',
		url: 'script/showotherpaylogscript.php',
		data: {schclass:schclass,paytype:paytype},		
		dataType:'html',
