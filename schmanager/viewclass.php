		...
		<div class="box" id="regbox">
            <div class="box">
                <div class="box-header">
                  ...
                  <a href="addclass.php" class="btn btn-success pull-right" data-action="addclass" data-toggle="tooltip" data-placement="bottom" title="Add New Class"><i class="fa fa-plus"></i> </a>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<script>
      $(function () {
		...
		"responsive": true,
		"bProcessing": true,
		"sAjaxSource": "script/classviewscript.php",
		"bPaginate":true,
          ...
          render : function (mData, type, row) {
             return mData == '1' ? 'Active' : 'Inactive'
			  ...
			  "render": function (data, type, row, meta) {
				  return '<a href="#" class="add btn btn-xs btn-primary" id="classviewbut" data-id="' + data + '" data-toggle="tooltip" data-placement="bottom" title="View Full Class Detail"><i class="fa fa-eye"></i></a>&nbsp;<a href="#" class="add btn btn-xs btn-info" id="classeditbut" data-id="' + data + '" data-toggle="tooltip" data-placement="bottom" title="Edit Class Information"><i class="fa fa-pencil-square-o"></i></a>&nbsp;<a href="#" class="remove btn btn-xs btn-danger" id="classdelete" data-id="' + data + '" data-toggle="tooltip" data-placement="bottom" title="Delete Class From School"><i class="fa fa-minus-circle" data-id="" data-name=""></i></a>'
				  orderable: false
