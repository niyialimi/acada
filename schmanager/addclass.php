        ...
        <div class="box" id="regbox">
            <div class="box-body">
              <div class="register-box-body">
                <p class="login-box-msg">Add New Class</p>
        
        <form action="" class="classform" id="newclassform"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">
        <input type="hidden" name="clientappid" id="clientappis" value="<?php echo $_SESSION['clientappid']; ?>">     
         ...
         <div class="row has-feedback">
                  ...
                  <div class="form-group has-feedback">
                    <input type="text" name="clalias" id="clalias" class="form-control" placeholder="" data-error="" readonly required>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6"> 
             		...
             		<div class="form-group has-feedback">
                    <input type="text" name="clarm" id="clarm" class="form-control" placeholder="either A or B or C e.t.c or type None" data-error="Field is Empty" required>
                    <span class="fa fa-university form-control-feedback"></span>
        ...
        <div class="row has-feedback">
          ...
          <div class="row">            
            ...
            <div class="col-xs-12 col-md-4 col-lg-4">            
              <button type="submit" id="addclassbut" name="addclassbut" class="btn btn-info" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Setting Up New Class">Set Up Class&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
</button>&nbsp;&nbsp;
            </div><!-- /.col -->
