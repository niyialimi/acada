...
<html>
  <head>
    ...
    <title>:: Communicate | E-mail</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-envelope"></i> Communicate</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="box box-primary">
                ...
                <div class="box-body">
                <form action="script/messagescript.php" class="stdatted" id="stdattendform"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <button type="submit" name="snedmsgbut" id="sendmsgbut" class="btn btn-primary">Send Message <i class="fa fa-send-o"></i></button>
                  </div>
