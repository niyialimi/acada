...
<html>
  ...
  <body class="hold-transition login-page" style="background:url(../dist/img/admin.png) no-repeat">
    <div class="login-box">
      <div class="login-logo">
        <a href="index.php"><img src="../dist/img/Erudite Logo diamond 1aa.png"></a>
      </div><!-- /.login-logo -->
                        ...
                        <form action="" class="logform" id="loginform" method="post" enctype="multipart/form-data" data-toggle="validator" role="form">
                            <fieldset>
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" placeholder="Login ID" name="adminlogid" id="adminlogid" autofocus required>
                                    <span class="form-control-feedback"></span>
                                </div>
                                
                                <div class="form-group">
                                    <input type="password" class="form-control" placeholder="Password" name="adminpassword" id="adminpassword" required>
                                    <span class="form-control-feedback"></span>
                                </div>                                
