    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-edit"></i> Manage Subject
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-edit"></i> Manage Subject</a></li>
        ...
        <input type="hidden" name="subjectid" id="subjectid" value="<?php echo $rows['subject_id']; ?>">     
         ...
         <div class="row form-group has-feedback">
                    ...
                    <input type="text" name="subname" id="subname" class="form-control" placeholder="" value="<?php echo $rows['subject_name']; ?>" data-error="Surname cannot be empty" required>
            ...
            <select class="form-control" name="subcategory" id="subcategory">
           				  <option value="General"><?php echo $rows['subject_category']; ?></option>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6"> 
                        <label>Alias</label>                      
             		<div class="form-group has-feedback">
                    <input type="text" name="subalias" id="subalias" class="form-control" placeholder="for example Mathematics can be MTH"  value="<?php echo $rows['subject_alias']; ?>" data-error="Field is Empty" required>
                    <span class="fa fa-book form-control-feedback"></span>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6">
                   ...
                   <div class="form-group has-feedback">
                    <input type="number" name="submark" id="submark" class="form-control" value="<?php echo $rows['subject_mark']; ?>" placeholder="Average Pass Mark for the subject e.g 50" data-error="Field is Empty" required>                    
                    <div class="help-block with-errors"></div>
                  </div>
          	 </div><!-- /.row -->
          </div>
          ...
          <div class="row">            
            ...
            <div class="col-xs-12 col-md-4 col-lg-4">            
              <button type="submit" id="subjectedit" name="subjectedit" class="btn btn-info" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Editing Subject Detail">Edit Subject&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
</button>
            </div><!-- /.col -->
