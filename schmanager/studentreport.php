		...
		<div class="box" id="regbox">
            <div class="box">
                <div class="box-header">
                  <h4 class="box-title well-lg"><i class="fa fa-calender"></i>  Students Monthly Attendance Report</strong></h4>
                  ...
                  <div class="col-md-3">
                  	...
                  	<select class="form-control" name="attendmonth" id="attendmonth">
                  ...
                  <div class="col-md-3">
                  <select class="form-control" name="attendclass" id="attendclass">
                 ...
                 <div class="col-md-2">
                 	<select class="form-control" name="attendarm" id="attendarm">
                    <option value="">Pick Arm/Section</option>
