...
<html>
  ...
  <body class="hold-transition skin-blue fixed sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <p class="login-box-msg">Add New Payment</p>
        
        <form action="" class="payform" id="createpayform"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">
        <input type="hidden" name="clientappid" id="clientappid" value="<?php echo $_SESSION['clientappid']; ?>">     
         ...
         <div class="row form-group has-feedback">
                  ...
                  <div class="form-group has-feedback">
                    <input type="text" name="payname" id="payname" class="form-control" value="" placeholder="" required>
                  ...
                  <div class="form-group has-feedback">
                   <select class="form-control" name="payclass" id="payclass" requiured>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6"> 
                    ...
                    <input type="text" name="payamount" id="payamount" class="form-control" value="" placeholder="" required>
                        <div class="help-block with-errors"></div>
                      </div>    
                  </div>               
                            
                  <div class="col-xs-12 col-md-6 col-lg-6">  
                  <label>Payement Description</label>                                     
                   <div class="form-group has-feedback">
                    <textarea rows="3" maxlength="200" class="form-control" name="paydesc" id="paydesc" placeholder="Description goes Max 200 characacter"></textarea>
        ...
        <div class="row form-group has-feedback">
          ...
          <div class="row">            
            ...
            <div class="col-xs-12 col-md-4 col-lg-4">            
              <button type="submit" id="createpaybut" name="createpaybut" class="btn btn-info" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Creating Payment">Create Payment&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
</button>
            </div><!-- /.col -->
        ...
        <div class="table-responsive">
           <table width="80%" id="stdtable1" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <th>Fee Description</th>
           			   ...
           			   <?php
		 			  	$selectsql='select * from setpayment where clientapp_id='.$_SESSION['clientappid'].' ';
							$result=mysqli_query($con,$selectsql);
								if (mysqli_num_rows($result))
								{
									while($rows=mysqli_fetch_assoc($result))
           ...
           <tr>
            ...
            <td><?php echo $rows['pay_class']; ?></td>
            <td><?php echo $rows['pay_amount']; ?></td>
            <td><?php echo $rows['pay_desc']; ?></td>
           </tr>
           </tbody>
      				     <?php
									}
  ...
  <script type="text/javascript">
        $(document).ready(function() {			           
            ...
            $('#payamount').keypress(function(event) {
