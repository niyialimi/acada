...
<html>
        ...
        <section class="content">
          ...
          <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                        <div class="table-responsive">
                         	<div class="chart">
                            <canvas id="doughnut-1" style="height:250px"></canvas>
                          </div>
                      </div>
                    </div><!-- /.col -->
                  </div><!-- /.row -->
            ...
            <div class="col-md-6 col-sm-12">
            	...
            	<div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Student Attendance Summary</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      	<div class="chart">
                            <canvas id="doughnut-2" style="height:250px"></canvas>
                          </div>
                    </div><!-- /.col -->
  ...
  <script>
	...
	$.ajax({
		url: "script/studentattendancedata.php",
		method: "POST",
