...
<html>
  <head>
    ...
    <title>::Create Staff Login</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-lock"></i> Manage Login
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-lock"></i> Manage Login</a></li>
            <li class="active">Create Login</li>
          </ol>
        </section>
        ...
        <p class="login-box-msg">New Staff Login</p>
         ...
         <div class="row form-group has-feedback">
                    <div class="col-xs-12 col-md-6 col-lg-6">                      
                       <label>Staff Name</label>                       
           			 <select class="form-control" name="staffname" id="staffname"  required>  
                     <option value="" readonly>Select Staff</option> 
                      <?php
							  
							  $xquery="select * from staff_tab";
							  $output=mysqli_query($con,$xquery);
							   if(mysqli_num_rows($output))
							   {
								   while($rows=mysqli_fetch_array($output))
								   {
									   ...
									   $_SESSION['staffphone']=$rows['staff_phone'];
						?>   
                     	
                          <option value="<?php echo $_SESSION['staffid']; ?>"><?php echo $_SESSION['stafflname']." ".$_SESSION['stafffname']; ?></option>
                  ...
                  <div class="form-group has-feedback">
                    <input type="text" name="staffphone" id="staffphone" class="form-control" value="" placeholder="" readonly required>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6"> 
             		...
             		<div class="form-group has-feedback">
                    <input type="text" name="staffuname" id="staffuname" class="form-control" placeholder="Login Username for parents" data-error="Field is Empty" required>
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-6">
                   ...
                   <div class="form-group has-feedback">
                    <input type="password" name="staffpass" id="staffpass" class="form-control" placeholder="Login Password" min-lenght="8" data-error="Field is Empty" required>
        ...
        <div class="row form-group has-feedback">
          ...
          <div class="row">            
            ...
            <div class="col-xs-12 col-md-4 col-lg-4">            
              <button type="submit" id="staffasslogin" name="staffasslogin" class="btn btn-info" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Creating Staff Login">Create Login&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
</button>
            </div><!-- /.col -->
