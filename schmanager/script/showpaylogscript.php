...
if(isset($_POST['schclass']))
{
  ...
  // $classselect=$_POST['classselect'];	
	$searchquery = "select * from setpayment where pay_class='".$_POST['schclass']."' and pay_name='School Fees'  and clientapp_id='".$_SESSION['clientappid']."'";
