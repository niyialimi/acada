...
FROM student_tab inner join stdattend_tab on student_tab.student_id=stdattend_tab.student_id where stdattend_tab.month='$monthName' and stdattend_tab.csession='$attendsession' and stdattend_tab.cterm='$attendterm' and student_tab.current_class='$attendclass' and student_tab.current_arm='$attendarm' and stdattend_tab.clientapp_id='".$_SESSION['clientappid']."'  GROUP BY stdattend_tab.student_id" ;
