              ...
              <div class="box box-warning">
                ...
                <?php 
				  	$msgid=$_GET['msgid'];
							 ...
							 $xquery="select * from message_tab where msg_sender!='School Admin' and msg_id='$msgid' and clientapp_id='".$_SESSION['clientappid']."'";
                 ...
                 <?php 
				 		$update="update message_tab set msg_readstatus=1 where msg_id='".$_SESSION['msgid']."' and clientapp_id='".$_SESSION['clientappid']."' ";
