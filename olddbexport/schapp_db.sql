...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2018 at 03:40 PM
...
(50, 1, '07088683944', 'BABATUNDE', '$2y$10$DHuSJOtdNN01Trys0z5N/uHomk9i5UW0wUCQLj4URpcpm4/4bLi9C');
...
--
ALTER TABLE `parent_login`
  MODIFY `parent_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
--
...
--
ALTER TABLE `stdattend_tab`
  MODIFY `at_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
