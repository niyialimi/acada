...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2018 at 02:30 PM
...
(2, 1, 'Nursery 1', 'Nur 1', 'None', 2, 'A', 20, 'Mathematics,English Language,Physics,Chemistry,Commerce,Biology,Geography,Economics,Government,Quantitative & verbal Reasoning,Religion & national Value,', 1, '2017-12-11'),
...
(44, 1, 'Senior Secondary School 3', 'SSS 3', 'None', 2, 'A', 0, 'Mathematics,English Language,Physics,Chemistry,Biology,Further Mathematics,Computer Studies,Agricultural Science,', 1, '2018-03-11');
...
(13, 1, 'Tsxyfcuukgkglig', 'Parents', 'Nbxsjhjhhjxsxs', 'Admin', 1, 0, '2018-02-11', '11:52:00'),
(14, 1, 'Jst for fun', 'School Admin', 'Jst for fun', 'staff', 2, 1, '2018-02-14', '12:43:00'),
(15, 1, 'Am testing', 'Admin', 'Am also testing', 'Parent', 10, 0, '2018-03-28', '04:01:00');
...
(10, 1, '08054329226', 'justine', '$2y$10$BGflgJSoMyV4cLm7FZma9OpfhIRurfbBDYgDVvsXRE8.tokx91z8.'),
(13, 1, '08057641404', 'OLORUNSUYI', '$2y$10$iOD6ZnQl95B5HQlGoec.5uZXRECKsZy14RkyP6DVqr2DyLlDpNb66'),
(28, 1, '08168905925', 'HASSAN', '$2y$10$Xw9VO1QPK9oZ.jmrpcbUpOUxuKBuZrawIE9ioVBBHrRmJ8viv//PS'),
(35, 1, '08076765775', 'LEELEE', '$2y$10$.XKK5BIYuhfJMS.mgU63suOoaJ8I/UmnWW.nsTAQKmCilduPzUg9e'),
(41, 1, '07088683944', 'BABATUNDE', '$2y$10$g063FBLqmG7NzaTM8sJqEOuslL8lR/X3N.6Va5VSB8ddo/Iz2gTf6');
...
INSERT INTO `payment_tab` (`payment_id`, `clientapp_id`, `student_id`, `student_class`, `payment_session`, `payment_term`, `payment_for`, `payment_amount`, `amount_paid`, `payment_date`) VALUES
(5, 1, 2, 'KG', '2018/2019', 'First', 'School Fees', '10000.00', '0.00', '2018-02-11'),
(14, 1, 16, 'Nursery 3', '2018/2019', 'First', 'School Fees', '300000.00', '0.00', '2018-02-13'),
(15, 1, 21, 'Primary 1', '2018/2019', 'First', 'School Fees', '400000.00', '0.00', '2018-02-13'),
(16, 1, 24, 'Primary 1', '2018/2019', 'First', 'School Fees', '400000.00', '0.00', '2018-02-13'),
(17, 1, 13, 'Nursery 2', '2018/2019', 'First', 'School Fees', '300000.00', '0.00', '2018-02-13'),
(18, 1, 11, 'Nursery 2', '2018/2019', 'First', 'School Fees', '300000.00', '0.00', '2018-03-05');
...
(13, 13, 'gloriousadmin', '$2y$10$tHCM4V9IablgN0u5KW2QROE.MyRXL/NDYo1n2wJWPS5JHFCizhj0.', 'Systemadmin');
...
(1, 1, 53, 'Junior Secondary School 1', '2017/2018', 'First', 'FirstCA', 'Mathematics', 10, '1/18/18', '03/01/2018'),
...
(18, 1, 53, 'Junior Secondary School 1', '2017/2018', 'First', 'SecondCA', 'English Language', 10, '2/26/18', '03/01/2018'),
...
(66, 1, 53, 'Junior Secondary School 1', '2017/2018', 'Second', 'FirstCA', 'English Language', 13, '03/02/2018', '03/01/2018'),
...
(81, 1, 53, 'Junior Secondary School 1', '2017/2018', 'Second', 'SecondCA', 'Mathematics', 10, '03/03/2018', '03/01/2018'),
...
(193, 1, 55, 'Junior Secondary School 1', '2017/2018', 'First', 'FirstCA', 'Mathematics', 10, '1/18/18', '03/01/2018'),
(194, 1, 55, 'Junior Secondary School 1', '2017/2018', 'First', 'FirstCA', 'English Language', 10, '1/18/18', '03/01/2018'),
...
(209, 1, 55, 'Junior Secondary School 1', '2017/2018', 'First', 'SecondCA', 'Mathematics', 10, '2/26/18', '03/01/2018'),
...
CREATE TABLE `setting_tab` (
  ...
  `clientapp_sign` varchar(250) NOT NULL,
  `clientapp_email` varchar(300) NOT NULL,
  `clientapp_mobile` varchar(20) NOT NULL,
  `clientapp_address` varchar(500) NOT NULL,
  `clientapp_country` varchar(100) NOT NULL,
  `clientapp_state` varchar(100) NOT NULL,
  `clientapp_city` varchar(100) NOT NULL,
  `clientapp_web` varchar(200) NOT NULL,
  `current_term` varchar(10) NOT NULL,
  `clientapp_tbegin` date NOT NULL,
  `clientapp_tend` date NOT NULL,
...
INSERT INTO `setting_tab` (`clientapp_id`, `clientapp_name`, `clientapp_logo`, `clientapp_sign`, `clientapp_email`, `clientapp_mobile`, `clientapp_address`, `clientapp_country`, `clientapp_state`, `clientapp_city`, `clientapp_web`, `current_term`, `clientapp_tbegin`, `clientapp_tend`, `current_session`, `reg_date`) VALUES
(1, 'OASOS', 'schlogo/schlogo1.png', 'schlogo/sign1.png', 'Nathanieladeniran@gmail.com', '08168905925', 'Iwo-road', 'Nigeria', 'Oyo', 'Ibadan', 'www.school.com', 'First', '2018-01-08', '2018-03-23', '2017/2018', '2018-02-02'),
(10, 'OBMS', 'schlogo/agrii.png', '', 'nathanieladeniran@gmail.com', '07088683944', '#38, Precious Lodge, Apena, Oganla, Off Wire and Cable Apata Ibadan', '', '', '', '', 'First', '0000-00-00', '0000-00-00', '2018/2019', '2018-02-02'),
(11, 'Glorious', 'schlogo/agrii.png', '', 'glorious@gmail.com', '08054291827', '#38, Precious Lodge, Apena, Oganla, Off Wire and Cable Apata Ibadan', '', '', '', '', 'First', '0000-00-00', '0000-00-00', '2018/2019', '2018-02-11'),
(12, 'Ariyo International', 'schlogo/agrii.png', '', 'glorious@gmail.com', '08168905925', '#38, Precious Lodge, Apena, Oganla, Off Wire and Cable Apata Ibadan', '', '', '', '', 'First', '0000-00-00', '0000-00-00', '2018/2019', '2018-03-06'),
(13, 'HoneyGold International', '', '', 'hn@gmail.com', '08168905925', '#38, Precious Lodge, Apena, Oganla, Off Wire and Cable Apata Ibadan', 'Nigeria', 'Oyo', '', '', 'First', '0000-00-00', '0000-00-00', '2018/2019', '2018-03-12');
...
INSERT INTO `staffattend_tab` (`sat_id`, `clientapp_id`, `staff_id`, `attendance_status`, `month`, `year`, `day_of_week`, `day_of_month`, `date`, `csession`, `cterm`) VALUES
(1, 1, 2, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(2, 1, 4, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(3, 1, 5, 'A', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(4, 1, 6, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(5, 1, 7, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(6, 1, 10, 'A', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(7, 1, 12, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(8, 1, 13, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(9, 1, 14, 'A', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(10, 1, 15, 'A', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(11, 1, 16, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(12, 1, 17, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(13, 1, 19, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(14, 1, 20, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(15, 1, 21, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(16, 1, 22, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(17, 1, 23, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(18, 1, 25, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(19, 1, 26, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(20, 1, 27, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(21, 1, 28, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(22, 1, 31, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First'),
(23, 1, 33, 'P', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First');
...
INSERT INTO `stdattend_tab` (`at_id`, `clientapp_id`, `student_id`, `student_class`, `month`, `year`, `day_of_week`, `day_of_month`, `date`, `csession`, `cterm`, `attendance_status`) VALUES
(2, 1, 53, 'Junior Secondary School 1', 'February', '2018', '1', '1', '2018-02-01', '2017/2018', 'First', 'P'),
(3, 1, 55, 'Junior Secondary School 1', 'February', '2018', '1', '1', '2018-02-01', '2017/2018', 'First', 'P'),
(4, 1, 53, 'Junior Secondary School 1', 'February', '2018', '2', '2', '2018-02-02', '2017/2018', 'First', 'A'),
(5, 1, 55, 'Junior Secondary School 1', 'February', '2018', '2', '2', '2018-02-02', '2017/2018', 'First', 'P'),
(6, 1, 53, 'Junior Secondary School 1', 'February', '2018', '3', '5', '2018-02-03', '2017/2018', 'First', 'A'),
(7, 1, 55, 'Junior Secondary School 1', 'February', '2018', '3', '5', '2018-02-03', '2017/2018', 'First', 'P'),
(8, 1, 53, 'Junior Secondary School 1', 'February', '2018', '4', '6', '2018-02-04', '2017/2018', 'First', 'P'),
(9, 1, 55, 'Junior Secondary School 1', 'February', '2018', '4', '6', '2018-02-04', '2017/2018', 'First', 'A'),
(10, 1, 53, 'Junior Secondary School 1', 'February', '2018', '5', '7', '2018-02-05', '2017/2018', 'First', 'P'),
(11, 1, 55, 'Junior Secondary School 1', 'February', '2018', '5', '7', '2018-02-05', '2017/2018', 'First', 'P'),
(12, 1, 53, 'Junior Secondary School 1', 'February', '2018', '1', '8', '2018-02-06', '2017/2018', 'First', 'P'),
(13, 1, 55, 'Junior Secondary School 1', 'February', '2018', '1', '8', '2018-02-06', '2017/2018', 'First', 'P'),
(14, 1, 53, 'Junior Secondary School 1', 'February', '2018', '2', '9', '2018-02-07', '2017/2018', 'First', 'A'),
(15, 1, 55, 'Junior Secondary School 1', 'February', '2018', '2', '9', '2018-02-07', '2017/2018', 'First', 'P'),
(16, 1, 53, 'Junior Secondary School 1', 'February', '2018', '3', '12', '2018-02-08', '2017/2018', 'First', 'P'),
(17, 1, 55, 'Junior Secondary School 1', 'February', '2018', '3', '12', '2018-02-08', '2017/2018', 'First', 'P'),
(18, 1, 53, 'Junior Secondary School 1', 'February', '2018', '4', '13', '2018-02-09', '2017/2018', 'First', 'P'),
(19, 1, 55, 'Junior Secondary School 1', 'February', '2018', '4', '13', '2018-02-09', '2017/2018', 'First', 'P'),
(20, 1, 53, 'Junior Secondary School 1', 'February', '2018', '5', '14', '2018-03-10', '2017/2018', 'First', 'P'),
(21, 1, 55, 'Junior Secondary School 1', 'February', '2018', '5', '14', '2018-02-10', '2017/2018', 'First', 'P'),
(27, 1, 53, 'Junior Secondary School 1', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First', 'A'),
(28, 1, 55, 'Junior Secondary School 1', 'March', '2018', '2', '20', '2018-03-20', '2017/2018', 'First', 'P'),
(29, 1, 2, 'KG', 'March', '2018', '4', '29', '2018-03-29', '2017/2018', 'First', 'P'),
(30, 1, 3, 'KG', 'March', '2018', '4', '29', '2018-03-29', '2017/2018', 'First', 'P'),
(31, 1, 4, 'KG', 'March', '2018', '4', '29', '2018-03-29', '2017/2018', 'First', 'A'),
(32, 1, 5, 'KG', 'March', '2018', '4', '29', '2018-03-29', '2017/2018', 'First', 'P');
...
(3, 1, 'AGARA', 'TOLUWALOPEMI', 'MARY', 'agara.tolulope@gmail.com', '2018', '2027', 'KG', 'None', 'STD00087', 2, '2017/2018', 'Second Term', 'Female', 'Nigerian', 'Oyo', 'Christianity', 'Apata', 'Ibadan', '2016-09-06', 'No', 0, 'AGARA', 'OLUWADAISI', 'Mr', 'agara.oluwadaisi@yahoo.com', 'No, Ibadan, Oyo State, Ibadan', '08054291827', 'Ibadan', 'Trader', 'Trader', '', '2018-02-09', '', '', '1', 'Dancing'),
...
(5, 1, 'HASSAN', 'FIRDAUSI', '', 'hassan.firdausi@gmail.com', '2018', '2027', 'KG', 'None', 'STD00089', 2, '2017/2018', 'Second Term', 'Male', 'Nigerian', 'Kwara', '', '', '', '2016-02-05', '', 0, 'HASSAN', 'ABDULLAHI', 'Engr.', 'hassan.abdullahi@yahoo.com', 'No, Ibadan, Oyo State, Ibadan', '08168905925', 'Ibadan', 'Civil Engineer', 'Father', '', '2018-02-09', '', '$2y$10$aEu8XB5MX54ngSw/ele9/ehzstSAuTcW1ODhnYFlWO/o8fOGk2e4G', '1', 'Dancing'),
...
(53, 1, 'BABATUNDE', 'FOLASADE', 'MOTUNRAYO', 'babatunde.folasade@gmail.com', '2017', '2023', 'Junior Secondary School 1', 'A', 'STD00081', 11, '2017/2018', 'Second Term', 'Female', 'Nigerian', 'Oyo', 'Christianity', 'kfndihioh', 'ikniohoh', '2007-02-05', 'No', 0, 'BABATUNDE', 'AROSANYIN', 'Engr.', 'babatunde.arosanyin@yahoo.com', 'No, Ibadan, Oyo State, Ibadan', '07088683944', 'Ibadan', 'Mechanical Engineer', 'Father', 'stdimage/IMG-20160709-WA0001.jpg', '2017-02-09', '', '$2y$10$zS3ZdWCimkq9V.dVUwYD9O6HgZy2SmEv3638asN5keyCbddU5VtMu', '1', 'Dancing'),
(55, 1, 'LEELEE', 'WAAKA', '', 'leelee.waaka@yahoo.com', '2017', '2023', 'Junior Secondary School 1', 'B', 'STD00083', 10, '2017/2018', 'Second Term', 'Male', 'Nigerian', 'Edo', '', '', '', '2008-02-05', '', 0, 'LEELEE', 'VICTOR', 'Mr', 'leelee.victor@yahoo.com', 'No, Ibadan, Oyo State, Ibadan', '08076765775', 'Ibadan', 'trader', 'Father', '', '2017-02-09', '', '$2y$10$Zg7C5sjN12CwgYlttQTBGO.C0XMfQXJo02Kj83C4BrqPIteambrHi', '1', 'Dancing'),
...
--
-- Table structure for table `timetable_tab`
--

CREATE TABLE `timetable_tab` (
...
--
-- Dumping data for table `timetable_tab`
--

INSERT INTO `timetable_tab` (`t_id`, `clientapp_id`, `class_id`, `subject_name`, `period`, `start_time`, `end_time`, `current_term`, `current_session`, `staff_id`, `day_of_week`) VALUES
(1, 1, 24, 'Mathematics', '1st', '08:00:00', '08:40:00', 'First', '2017/2018', 2, '1'),
(2, 1, 24, 'English Language', '2nd', '09:00:00', '09:40:00', 'First', '2017/2018', 4, '1'),
(3, 1, 24, 'Physics', '3rd', '10:00:00', '10:30:00', 'First', '2017/2018', 6, '1'),
(4, 1, 24, 'Chemistry', '1st', '08:00:00', '09:00:00', 'First', '2017/2018', 10, '2'),
(5, 1, 24, 'Biology', '2nd', '09:10:00', '10:00:00', 'First', '2017/2018', 6, '2'),
(6, 1, 24, 'Commerce', '3rd', '09:10:00', '10:00:00', 'First', '2017/2018', 12, '5'),
(14, 1, 30, 'English Language', '2nd', '09:00:00', '09:30:00', 'First', '2017/2018', 4, '1'),
(15, 1, 30, 'Chemistry', '1st', '08:00:00', '08:40:00', 'First', '2017/2018', 7, '2');
...
--
-- Indexes for table `timetable_tab`
--
ALTER TABLE `timetable_tab`
...
--
ALTER TABLE `message_tab`
  MODIFY `msg_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `parent_login`
  MODIFY `parent_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `schadmin_tab`
  MODIFY `adm_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `setting_tab`
  MODIFY `clientapp_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `staffattend_tab`
--
ALTER TABLE `staffattend_tab`
  MODIFY `sat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
-- AUTO_INCREMENT for table `timetable_tab`
--
ALTER TABLE `timetable_tab`
