...
$staffattendsession=$_POST['staffattsession'];
$staffattendterm=$_POST['staffattterm'];
$month=$_POST['staffattmonth'];
//$staffattendsession='2017/2018';
//$staffattendterm='First';
//$month=2;

$monthName = date("F", mktime(0, 0, 0, $month, 10));
if($month && $staffattendsession && $staffattendterm)
{
$month=$month;
$year=date('Y');
...
if(mysqli_num_rows($result))
 {	
 	echo '<div class="table-responsive"><table width="75%" class="table table-bordered" style="width:75%;"><tbody>';
			echo '<tr><td colspan="28" align="center"><strong>'.$_SESSION["classname"].' '.$_SESSION['classarm'].' Attendance Report For '.$monthName." ".$year.'</strong></td></tr>';
			
			//';
			
			$days=array();
				echo '<tr align="center" style="background:#39C; color:#FFF;">';
				for($d=1; $d<=31; $d++)
				{
...
if(mysqli_num_rows($result))
 {	
 	echo '<div class="table-responsive"><table width="75%" class="table table-bordered" style="width:75%;"><tbody>';
			echo '<tr><td colspan="30" align="center"><strong>'.$_SESSION["classname"].' '.$_SESSION['classarm'].'Attendance Report For '.$monthName." ".$year.'</strong></td></tr>';
...
if(mysqli_num_rows($result))
 {	
 	echo '<div class="table-responsive"><table width="75%" class="table table-bordered" style="width:75%;"><tbody>';
			echo '<tr><td colspan="31" align="center"><strong>'.$_SESSION['stafflname'].' '.$_SESSION['stafffname'].' Attendance Report For '.$monthName." ".$year.'</strong></td></tr>';
