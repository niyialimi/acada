...
$_SESSION['toprightstaff'].='<div class="navbar-custom-menu">
...
$result=mysqli_query($con,$noticequery);
             ...
             $_SESSION['toprightstaff'] .=' <!-- Notifications: style can be found in dropdown.less -->
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../'.$_SESSION['staffpics'].'" class="user-image" alt="User Image">
                  <span class="hidden-xs">'.$_SESSION['staffusername'].'</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../'.$_SESSION['staffpics'].'" class="img-circle" alt="User Image"> 
                    <p>'.$_SESSION['staffusername'].'</p>                  
                  </li>
