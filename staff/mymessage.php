    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-3">
              <a href="composemsg.php" class="btn btn-primary btn-block margin-bottom">Compose Message</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="mymessage.php"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">X</span></a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">                  
                    ...
                    <?php
							 ...
							 $xquery="select * from message_tab where msg_sender!='staff'";
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-attachment"><i class="fa fa-calender"></i><?php echo $rows['msg_date']; ?></td>
                          <td class="mailbox-date"><i class="fa fa-time"></i><?php echo $rows['msg_time']; ?></td>
                        </tr>
                        <?php 
							   }
							}else{
