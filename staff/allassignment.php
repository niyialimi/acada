          ...
          <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class=""><a href="assignment.php"><i class="fa fa-edit"></i> New Assignment</a></li>
                    <li><a href="allassignment.php"><i class="fa fa-list"></i> All Given Assignment<span class="label label-primary pull-right">X</span></a></li>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">All Assignment</h3>
                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="readmsg.php">&nbsp;</a></td>
