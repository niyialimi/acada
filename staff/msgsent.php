    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-3">
              <a href="composemsg.php" class="btn btn-primary btn-block margin-bottom">New Message</a>
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="mymessage.php"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">X</span></a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">                  
                    ...
                    <?php
							 ...
							 $xquery="select * from message_tab where msg_senderid='".$_SESSION['staffid']."' and message_sender='staff' and clientapp_id='".$_SESSION['clientappid']."'";
