    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-pencil"></i> My Class</a></li>
          ...
          <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class=""><a href="assignment.php"><i class="fa fa-edit"></i> New Assignment<span class="label label-primary pull-right">X</span></a></li>
                    <li><a href="allassignment.php"><i class="fa fa-list"></i> All Given Assignment</a></li>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">New Assignment/Term Paper</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="form-group">
                    <input  class="form-control" placeholder="" value="Subject:">
                  </div>
                  <div class="form-group">
                    
                  </div>
                  <div class="form-group">
                    <input class="form-control" placeholder="Duration or Submission time">
                  </div>
                  <div class="form-group">
                    <textarea id="composeasigment" class="form-control">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <button type="submit" class="btn btn-primary">Post Assignment <i class="fa fa-send-o"></i></button>
                  </div>
