            ...
            <div class="col-md-12 col-sm-12">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Class Exam Score</h3>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                      <div class="pad">
                       ...
                       <div align="center">
             <button type="submit" name="marksheetbut" id="marksheetbut" class="btn btn-info">Load Mark Sheet&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
            </div>
                                </form>
                            </div>
                            <div class="col-md-8 col-sm-12">
                                ...
                                <div class="panel panel-primary">
                                   ...
                                   <div class="panel-heading" id="showsubject" align="center"><strong>Exam Score Sheet</strong></div>
                                   <div class="panel-body">                                      
                                   <form action="" class="markform" id="stdmarkform"  enctype="multipart/form-data" method="post" role="form" data-toggle="validator">
                                  ...
                                  <table id="stdtable1" class="table table-bordered">
                                   ...
                                   <div id="message"> </div>
                                   <div align="center">
                                 <button type="submit" name="submarkbut" id="submarkbut" class="btn btn-info">Submit Marks Sheet&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok-sign"></span></button>
                                </div>
                                   </form>
