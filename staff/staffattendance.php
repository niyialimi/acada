...
<html>
  <head>
    ...
    <title>::My Attendance Summary</title>
                ...
                <div class="box-body no-padding">
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                     ...
                     <form action="" class="stdatted" id="staffattform"  enctype="multipart/form-data" method="post" role="form" data-toggle="">   
                 
                  <div class="col-md-4">
                  		<select class="form-control" name="staffattmonth" id="staffattmonth" required>
                  ...
                  <div class="col-md-4">
                  	<select class="form-control" name="staffattsession" id="staffattsession" required>
                  ...
                  <div class="col-md-4">
                  <select class="form-control" name="staffattterm" id="staffattterm" required>
                ...
                <form action="" class="atendtform" id="showattendform"  enctype="multipart/form-data" method="post" role="form">                
                	<div class="panel panel-primary">
                      <div class="panel-heading">
                        <h3 class="panel-title">My Monthly Atendance</h3>
                      </div>                      
